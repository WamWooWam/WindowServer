...
import { LPRECT, OffsetRect, POINT, RECT, SIZE, SetRect } from "../subsystems/gdi32.js";
...
import { GA, GW, HWND, HWND_BOTTOM, HWND_NOTOPMOST, HWND_TOP, HWND_TOPMOST, LOWORD, SM, SW, SWP, WINDOWPLACEMENT, WM, WS, WMP, WPF } from "../subsystems/user32.js";
...
async function NtUserWinPosDoNCCALCSize(wnd: WND, winPos: WINDOWPOS, windowRect: RECT, clientRect: RECT, validRects: LPRECT[]): Promise<number> {
    ...
    if ((winPos.uFlags & (SWP.FRAMECHANGED | SWP.NOSIZE)) != SWP.NOSIZE) {
        ...
        if (0 != (wnd.dwStyle & WS.CHILD) && parent) {
            ...
            OffsetRect((params.rgrc[1]) as RECT, - parent.rcClient.left, - parent.rcClient.top);
            OffsetRect((params.rgrc[2]) as RECT, - parent.rcClient.left, - parent.rcClient.top);
        }
